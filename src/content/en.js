...
export default {
 ...
 "m21": {
  "title": "📟 Observability & Incident Drills",
  "sub": "Three drills on the tools you actually reach for when something is wrong — logs, events, metrics — and then the pager. Logs accumulate per pod as the cluster runs; repeated events aggregate into a COUNT; metrics move. Missions are graded live as you type — no Check button.",
  "_ncards": 0,
  "missionsTitle": "Missions — graded live",
  "docsTitle": "📖 In the real docs",
  "btnReset": "Reset lab",
  ...
  "solutionTitle": "Reference solution",
  "solveNote": "Reference solution — watch the missions tick, then Reset and do it yourself.",
  "termHead": "cluster console — kubectl logs / get events / top",
  "greeting": "Simulated cluster. Type 'help' for commands — logs takes --tail, --since, --timestamps, --previous, -f.",
  "panelLogTails": "📜 Last log line per pod",
  "panelNoLines": "(nothing logged yet)",
  "panelLoudest": "📅 Loudest events (by COUNT)",
  "panelNoEvents": "no events yet",
  "panelSlo": "🎯 SLO",
  "panelAvailability": "availability",
  "panelBurn": "budget burn",
  "panelCpu": "📈 CPU per replica",
  "panelInject": "🧪 Inject a fault",
  "btnSpike": "Spike CPU",
  "btnBreak": "Break a replica",
  "tabIncident": "🚨 Incident (3am pager)",
  "incidentIntro": "A random fault fires and you get the SYMPTOM only — no diagnosis, like a real page. Two clocks run: time-to-diagnose stops when you declare a root cause, time-to-resolve when you fix it. Work the cluster first, declare second.",
  "pagerTitle": "PAGE",
  "pagerHint": "You were not told what is broken. Find out.",
  "mttrLabel": "MTTR",
  "ttdLabel": "diagnosed in",
  "btnDeclare": "I know the cause",
  "btnResolve": "I fixed it — grade me",
  "btnNewPage": "New page",
  "btnSolution": "Show the walkthrough",
  "declareTitle": "What is the root cause?",
  "declaredNote": "Root cause declared — the diagnose clock has stopped. Now fix it and hit “I fixed it”.",
  "resolvedTitle": "Incident resolved",
  "notResolvedTitle": "Not resolved yet",
  "causeLabel": "root cause",
  "causeRight": "named correctly",
  "causeWrong": "missed",
  "actualCause": "It was",
  "historyTitle": "Incident history",
  "poolNote": "{n} faults in the pool — the last few you saw are skipped, so pages stay unpredictable.",
  "clusterTitle": "Live cluster"
 }
};
